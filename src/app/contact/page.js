    ...
    <section className="relative w-full bg-[#dfeaff] bg-cover bg-center">
      <div className="container mx-auto px-6 py-16 md:px-24 lg:px-24">
        ...
        >
          ...
          {/* Right form */}
          <div
            className={`order-2 flex-1 w-full max-w-full space-y-6 transition-all duration-1000 ease-out ${
              topRef.isInView ? "translate-x-0 opacity-100" : "translate-x-10 opacity-0"
            }`}
          >
            <h3 className="text-3xl sm:text-4xl font-extrabold text-[var(--color-text-red-theme-500)] md:text-6xl">
            ...
            {/* FORM */}
            <form className="space-y-4 text-[#03052e] w-full pb-20">
              <div>
                <label className="text-sm font-semibold">Quý danh của bạn *</label>
                <input
                  type="text"
                  required
                  className="w-full rounded-md border border-gray-300 bg-white px-4 py-2 mt-1"
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full sm:w-auto rounded-md bg-[var(--color-text-red-theme-500)] px-6 py-3 font-semibold text-white hover:bg-white hover:text-[var(--color-text-red-theme-500)] transition border border-transparent hover:border-[var(--color-text-red-theme-500)]"
              >
                Gửi yêu cầu
              </button>
            </form>
