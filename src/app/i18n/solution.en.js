                ...
                items: [
                    {
                        label: "Video Ad",
                        description:
                            "Deliver brand stories with high-impact video across digital channels.",
                    ...
                    },
                    {
                        label: "Social Ad",
                        description:
                            "Execute scalable campaigns across Facebook, Instagram, TikTok, and more.",
                        icon: "/images/solution/icons/net.svg",
                    },
                    {
                        label: "Search Ad",
                        description:
                            "Capture demand with keyword-targeted ads on top search engines.",
                ...
                items: [
                    {
                        ...
                        description:
                            "Optimize campaigns by KPI CPC, CPL, CPS, CPA for measurable results.",
                ...
                items: [
                    {
                        ...
                        description:
                            "Shape fresh narratives that connect brand and audience meaningfully.",
