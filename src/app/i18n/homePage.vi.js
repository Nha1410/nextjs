export default {
  ...
  solutions: {
    ...
    intro2: "ANN Multimedia thiết kế các giải pháp truyền thông số & đa nền tảng giúp thương hiệu nổi bật một cách có chiến lược, được nhận diện rõ ràng, truyền tải đúng tinh thần và ghi dấu ấn bền vững trong tâm trí người tiêu dùng.",
    blocks: [
      {
        type: "SolutionBlock",
        title: "Social Advertisement",
        description: "Triển khai quảng cáo đa nền tảng với định dạng sáng tạo",
        items: ["Banner Chuẩn", "Video Quảng Cáo", "Native", "Action Ad", "3D Cubes", "3D Dancer"],
        secondItems: ["Glitch", "Carousel", "Swipe", "Countdown", "Reveal", "Shake"],
      ...
      },
      {
        ...
        description: "Đồng bộ nhận diện online & offline",
        items: ["Social Media", "Sites: E-news...", "Apps: Grab..."],
        secondTitle: "Online:",
        thirdTitle: "Offline:",
        secondItems: ["Billboard, LCD, Car Branding..."]
      },
      {
        type: "SolutionBlock",
        title: "Creative Planning & Deployment",
        description: "Ý tưởng rõ ràng, triển khai hiệu quả",
