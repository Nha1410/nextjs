            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
                    ...
                    <div className="flex flex-col px-15 md:col-span-2">
                        ...
                        <div>
                            <h3 className="mb-2 text-xl tracking-wide text-gray-500 uppercase">
                                ADDRESS
                            </h3>
                            <p className="text-sm leading-relaxed text-[#03052e]">
                                5 Nguyen Gia Thieu St., Vo Thi Sau ward, Dist. 3, Ho Chi Minh City,
                                Vietnam
                            </p>
                            <div className="mt-4">
                    ...
                    <div className="ml-10 flex h-full flex-col justify-between">
                        ...
                        <div>
                            ...
                            <div className="mt-4 flex space-x-4">
                                <img
                                    src="/images/icons/facebook.avif"
                                    alt="Facebook"
                                    className="h-10 w-10"
                                />
                                <img
                                    src="/images/icons/linkedin.avif"
                                    alt="LinkedIn"
                                    className="h-10 w-10"
                                />
                                <img
                                    src="/images/icons/instagram.avif"
                                    alt="Instagram"
                                    className="h-10 w-10"
                                />
                            </div>
