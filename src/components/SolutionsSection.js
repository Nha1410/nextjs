        ...
        <section className="overflow-hidden bg-[#dfeaff] py-16 text-[#03052e]">
            <div className="container mx-auto max-w-screen-xl items-start px-4 sm:px-6 md:px-8">
                ...
                <div className="mb-16 grid grid-cols-1 gap-8 md:grid-cols-2">
                    ...
                    <div>
                        <h2 className="mb-3 text-3xl leading-tight font-bold sm:text-4xl">
                            Our solutions
                        </h2>
                    ...
                    <div className="flex justify-center md:justify-end">
                        <div>
                            <p className="mb-6 text-base leading-relaxed text-gray-700 sm:text-lg">
                                Người dùng muốn trải nghiệm đa dạng, nhận hàng cận xuất hiện đa
                                kênh, Think Digital chuyển mình đa dạng hoá. <br />
                                Chúng tôi đưa ra các giải pháp cụ thể tập trung vào Marketing cho
                                doanh nghiệp, với các tập đoàn lớn để thúc đẩy mức tăng trưởng và
                                hiệu quả hoạt động.
                            </p>
                        </div>
                    </div>
                ...
                <div className="mb-16 grid grid-cols-1 gap-8 md:grid-cols-2 md:items-center">
                    ...
                    <div>
                        <h3 className="mb-4 text-xl leading-tight font-semibold sm:text-2xl">
                            1. Marketing &amp; Communication
                        </h3>
                        ...
                        <ul className="mb-5 list-disc space-y-2 pl-5 text-base leading-relaxed text-gray-700">
                            ...
                            <li>
                                <strong>Đội ngũ</strong> Marketing in-house, từ tư vấn đến triển
                                khai
                            </li>
                        </ul>
                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2 md:items-center">
                    ...
                    <div className="order-1 md:order-2">
                        ...
                        <p className="mb-5 text-base leading-relaxed text-gray-700">
                            Dễ dàng khám phá &amp; đặt mua hàng ngàn các quảng cáo đa dạng từ các
                            kênh targeting qua cổng, influencers, website hàng đầu Việt Nam.
                        </p>
                        <ul className="mb-5 list-disc space-y-2 pl-5 text-base leading-relaxed text-gray-700">
