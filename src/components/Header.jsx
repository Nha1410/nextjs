    ...
    >
      <div className="container mx-auto flex h-30 items-center justify-between px-4">
        ...
        <nav className="hidden space-x-6 md:flex">
          <Link href="/" className="text-white transition hover:text-gray-200">Home</Link>
        ...
        <div className="flex items-center space-x-4">
          <div className="relative hidden sm:block">
            ...
            />
            <svg className="absolute top-3 left-3 h-4 w-4 text-gray-300" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
